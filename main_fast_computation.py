...
# in this version the computation of the matrix inverse and the matrix square root are not guaranteed
# and use the scipy and numpy libraries
# however the algorithm is faster
...
while alpha < alpha_max:
    ...
    Q_mid = mid_matrix(Q)
    G = scipy.linalg.sqrtm(np.linalg.inv(Q_mid))
    E_box = E_box_(G)
